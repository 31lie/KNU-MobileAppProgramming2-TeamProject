...
//  https://www.youtube.com/watch?v=y_vQvAqgqgA -> APIkey
...
enum VoiceType: String {
    ...
    case koreaA = "ko-KR-Wavenet-A"
}

let ttsAPIUrl = "https://texttospeech.googleapis.com/v1/text:synthesize"
let APIKey = "AIzaSyANCJu7maOopUbBphJhE5uxgtzRn4ThyUc"
...
class SpeechService: NSObject, AVAudioPlayerDelegate {
    ...
    func speak(text: String, voiceType: VoiceType = .koreaA, completion: @escaping () -> Void) {
